...
line-list or claims data set containing individual patient
outcomes. 
% \citep{HFR_linelist3, cfr_line_list}
Many effective works take this approach, such as \citet{cfr_line_list}, \citet{HFR_linelist1}, and \citet{HFR_linelist3}.
...
findings. 
Section S3 compares the ratio HFRs to multiple external estimates of the ground truth (Figure S3). 
It also studies the effect of using finalized count data (Figure S4) and different hyperparameter choices (Figures S5-7).
Finally, it examines the ratio estimators' behavior on six US states (Figure S8). 
