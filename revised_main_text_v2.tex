...
However, the following estimators and their biases are shared for any severity rate $p_t$, including CFR, IFR, and HFR. 
...
findings. 
Section S3 compares the HFR estimates to multiple alternative approximations of the ground truth (Figure S3). 
