...
We validate these findings empirically, tracking the hospitalization-fatality rate (HFR) during COVID-19. The ratio estimators failed to quickly signal increased risk in the onset of the Delta wave; later, in the aftermath of the inital Omicron wave, they surged while the true HFRs fell. 
...
\begin{enumerate}
    ...
    \item Smooth delay distribution with a heavier tail and higher mean than $\pi$. 
...
% Per our analysis, $A_t^\ell$ rises above 1, adding positive misspecification bias in \ref{thm:MispBias}. 
% This brings the lagged ratio closer to the true HFR. 
% The opposite 

% Analogously, the lagged bias is less \textit{positive} in February 2021 as hospitalizations fall. 
...
% Proposition \ref{thm:MispBias} expresses bias under misspecification via the rescaled oracle bias plus a misspecification term, both of which depend on the ratio $A_t^\gamma$. 
