...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{Figures/Real/ApproxGT.pdf}
...
\begin{figure}
     ...
     \begin{subfigure}[b]{0.45\linewidth}
         \centering
         \includegraphics[height=6cm]{Figures/Real/US_ests_realtime_both.pdf}
     ...
     \begin{subfigure}[b]{0.45\linewidth}
         \centering
         \includegraphics[height=6cm]{Figures/Real/death_curves.pdf}
