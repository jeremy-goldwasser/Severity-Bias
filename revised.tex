...
While several works 
assume severity rates are constant in time \citep{ghani, jewell2007nonparametric, reich2012estimating, lancet_controversial}, 
...
Standard approaches do so with a ratio of primary and secondary counts.
...
Intuitively, the bias of the well-specified convolutional ratio can be interpreted as a weighted average of the difference between trailing and current severity rates. 
